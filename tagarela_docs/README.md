...
- [`08-modulos-fase3.md`](./02-arquitetura/08-modulos-fase3.md) — snapshot pós-Fase 3 (release engineering): Developer ID Application + entitlements completos + notarization + DMG + Sparkle minimal + 7 scripts modulares + setup-dev. v1.0.0 e v1.0.1 publicadas em GitHub Releases. Cleanup #6 da Fase 1 (TCC manual via SQL) **fechado** — popups nativos voltaram pós Developer ID.
