...
- [`checklists/fase4-manual.md`](./03-funcionalidades/checklists/fase4-manual.md) — aceite manual da Fase 4 (5 blocos: pt explícito sem regressão, en explícito, Automático pt/en, frase curta no auto, troca em runtime + migração). Status `pendente`.
