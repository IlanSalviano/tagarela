...
> **Revisão 2026-09-24:** a decisão 3 valia "nesta fase" e foi revista a pedido do usuário — o menu ganha o item **"Buscar atualizações…"**. A checagem automática continua igual. Ver [design do item](./2026-09-24-tagarela-v1-buscar-atualizacoes-design.md).
